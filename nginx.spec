...
Source0  : https://nginx.org/download/nginx-1.25.1.tar.gz
Source1  : nginx-setup.service
Source2  : nginx.service
Source3  : nginx.tmpfiles
Source4  : https://nginx.org/download/nginx-1.25.1.tar.gz
...
%prep
%setup -q -n nginx-1.25.1
cd %{_builddir}/nginx-1.25.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691316219
